...
//   // 1. Initialize and Request Permission
...
//   // 2. Save Token to User's Document
//   Future<void> _saveTokenToDatabase(String token) async {
//     final user = FirebaseAuth.instance.currentUser;
//     if (user == null) return;

//     // We need to find which collection the user is in
//     // This is a quick helper to check all collections
//     final collections = [
//       'students',
//       'lecturers',
//       'facility_managers',
...
// import 'package:flutter_local_notifications/flutter_local_notifications.dart'; // Add this dependency if you want foreground popups
// import 'package:nileassist/main.dart'; // Import to access navigatorKey if you have one, or context
...
//             // Show a local dialog or snackbar so the user sees it immediately
//             // Or use flutter_local_notifications to show a system-like popup
...
//       // Navigate to the Complaint Detail Screen
//       // You need a global navigator key or context to do this
//       print("User tapped notification for ticket: ${message.data['ticketId']}");
//       // Example: navigatorKey.currentState?.pushNamed('/details', arguments: message.data['ticketId']);
//     }
//   }
...
//              print("⚠️ Skipping FCM token: APNS token not available (Simulator detected)");
//            }
//         } else {
